...
function Card(props) {
  return (
    <div className="w-64 m-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <a href="/" className='h-8 overflow-y-hidden'>
        <img className="rounded-t-lg h-48 w-full object-cover" src={props.img} alt="" />
      </a>
      <div className="p-4">
        <a href="/" className='box-content'>
        ...
        <p className="mb-3 font-normal  text-gray-900 dark:text-white">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
