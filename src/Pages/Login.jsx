...
dotenv.config();
    ...
    return (
        <section className="">
            <div className="pt-14 dark:bg-gray-900 bg-gray-200 flex flex-col items-center justify-center min-h-screen px-6 py-8 mx-auto lg:py-0">
