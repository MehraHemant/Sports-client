...
function Home() {
        ...
        if (value.length > 0) {
            fetch('https://sport-server-i5oo.onrender.com/sports', { mode: 'cors' })
                ...
                .then(data => {
                    ...
                    setData(result); 
                    (result.length == 0) && setLength(false);
                })
            }
        else {
            fetch('https://sport-server-i5oo.onrender.com/sports', { mode: 'cors' })
    ...
    return (
        ...
        <div className='min-h-screen dark:bg-gray-900'>
            ...
            <div className='flex justify-center mt-8 space-x-4 flex-wrap select-none'>
                <button className='dark:text-white m-2 border border-gray-600 min-w-[90px] p-2 rounded-2xl font-semibold transition-all duration-300 hover:bg-purple-600  hover:shadow-lg hover:shadow-purple-800' onClick={(e) => setData(tags)}>All</button>
                {tags.map((item, index) => {
            ...
            <div className='flex flex-wrap justify-center mt-10'>
                ...
                }):<div className='dark:text-gray-400 text-gray-700 text-4xl'>No Result Found</div>
                }
            </div>
